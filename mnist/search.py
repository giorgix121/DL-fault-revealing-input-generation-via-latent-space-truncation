...
class mimicry:
    ...
    def search(self):
        ...
        while frontier_seed_count < self.search_limit:
            ...
            # base image prediction class check
            ...
            # Search for fault revealing image by trunc_psi
            fault_found = False
            ...
            for trunc_psi in truncation_values:
                ...
                # If the classifier prediction flipped
                if fault_pred != base_pred:
                    ...
                    # Metadata for the fault revealing image
